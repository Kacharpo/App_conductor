...
import com.example.app_conductor.Registro.RegistroConstructor;
                ...
                try{
                    ...
                    databaseReference.child("Registro").addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            RegistroConstructor emp = new RegistroConstructor( "nombre", "apellido", "fecha", "numero", correo, "contrasena",  "licencia","true");
